...
def main():
    ...
    while True:
        ...
        if eth_proto == 8:
            ...
            os.system('ntfy -b telegram send "\n IPV4 Packet:"')
            os.system('ntfy -b telegram send "Version: {}, Header Length: {}, TTL: {}"'.format(version, header_length, ttl))
            os.system('ntfy -b telegram send "protocol: {}, Source: {}, Target: {}"'.format(proto, src, target))
            os.system('ntfy -b telegram send "Catched malicious request from {} to {}"'.format(src, target))
	    ...
	    #time.sleep(17)
            ...
            if proto == 1:
                ...
                os.system('ntfy -b telegram send "Type: {}, Code: {}, Checksum: {},"'.format(icmp_type, code, checksum))
                os.system('ntfy -b telegram send "ICMP Data:"')
                os.system('ntfy -b telegram send %s'%(format_output_line(DATA_TAB_3, data)))
                time.sleep(17)
	            # TCP
            elif proto == 6:
                ...
                os.system('ntfy -b telegram send "Source Port: {}, Destination Port: {}"'.format(src_port, dest_port))
                os.system('ntfy -b telegram send "Sequence: {}, Acknowledgment: {}"'.format(sequence, acknowledgment))
                os.system('ntfy -b telegram send "Flags:"')
                os.system('ntfy -b telegram send "URG: {}, ACK: {}, PSH: {}'.format(flag_urg, flag_ack, flag_psh))
                os.system('ntfy -b telegram send "RST: {}, SYN: {}, FIN:{}'.format(flag_rst, flag_syn, flag_fin))
